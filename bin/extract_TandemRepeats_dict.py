...
if __name__ == "__main__":
    ...
    if variant_type == "DEL":
        ...
        Popen("mv " + sample_name + "_DEL_with_alu.fasta.2.5.7.80.10.50.2000.dat" + " " + out_dir,shell=True).wait()
        ...
        Popen(trf_cmd,shell=True).wait()
        Popen("mv " + sample_name + "_INS_with_alu.fasta.2.5.7.80.10.50.2000.dat" + " " + out_dir,shell=True).wait()
